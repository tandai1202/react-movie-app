      ...
      <div className='w-full h-full flex items-center justify-center space-x-[50px] p-12 relative z-20'>
        <div className='flex flex-col space-y-5 items-baseline w-[50%]'>
            ...
            <div className='flex flex-col space-y-4'>
                <h2 className='text-white text-[40px] font-bold'>Nghe nói e thích tôi</h2>
                ...
                <p className='text-white'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting,</p>
